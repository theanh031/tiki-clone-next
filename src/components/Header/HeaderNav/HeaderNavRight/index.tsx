...
const items = [
    {
        id: 0,
        label: 'Trang chủ',
        icons: [<RiHome5Line key={0} className={iconStyle}/>, <RiHome5Fill key={1} className={iconStyle}/>]
    },
    {
        id: 1,
        label: 'Astra',
        icons: [<AiOutlineCrown key={0} className={iconStyle}/>, <AiFillCrown key={1} className={iconStyle}/>]
    },
    {
        id: 2,
        label: 'Tài khoản',
        icons: [<BsEmojiWink key={0} className={iconStyle}/>, <BsEmojiWinkFill key={1} className={iconStyle}/>]
    },
]
const Index = () => {
